...
![Field mode scanning](images/scan-field-mode.png)
...
![Face detected — Hold still](images/scan-hold-still.png)
![Identity ready — Face locked](images/scan-identity-ready.png)
...
![Profile card — Field Mode](images/profile-card-field.png)
![Scan result with equipment, style, pose bonuses](images/scan-result-bonuses.png)
...
![Possible Match panel](images/possible-match.png)
...
![Field 模式掃描](images/scan-field-mode.png)
...
![臉部偵測 — 保持不動](images/scan-hold-still.png)
![身份鎖定 — 臉部已鎖定](images/scan-identity-ready.png)

#### 角色卡（掃描完成後）

![角色卡 - Selfie 模式](images/profile-card-selfie.png)
...
![角色卡 - Field 模式](images/profile-card-field.png)
![裝備/服裝/姿勢加成](images/scan-result-bonuses.png)
...
![Possible Match 面板](images/possible-match.png)

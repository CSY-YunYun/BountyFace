...
const MAX_YAW_ANGLE = 45;
const MAX_ROLL_ANGLE = 30;
const MIN_SELFIE_FACE_WIDTH_RATIO = 0.25;
const MIN_FIELD_FACE_WIDTH_RATIO = 0.08;
const MAX_CENTER_OFFSET_X_RATIO = 0.30;
const MAX_CENTER_OFFSET_Y_RATIO = 0.32;
const REQUIRED_STABLE_MS = 800;
